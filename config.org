#+TITLE:Arkeus's GNU Emacs Config
#+AUTHOR: J Daniel Arce
#+DESCRIPTION: JD personal Emacs config
...
- [[#java][JAVA]]
  ...
  - [[#lsp-java][LSP JAVA]]
- [[#config-ansi-colors][CONFIG ANSI COLORS]]
- [[#eglot-lsp-using-it-for-cc][Eglot (lsp using it for c/c++)]]
